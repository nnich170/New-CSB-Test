...
def open_page_1():
    from open_booking import open_booking
    open_booking()
...
def promotion_page():
    ...
    booking_btn = tk.Button(upper_frame, text="Booking", font=("Times New Roman", 12, "bold"), fg="black", bg="#878378", command=open_booking)
    ...
    def fetch_from_database():
        try:
            ...
            # Attempt to fetch data from the promotions table
            try:
                ...
                ''')
                conn.commit()
                results = []  # No data since the table was just created
            ...
            for item in promotion_items:
                create_promo_display(promotion, item)
