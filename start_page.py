...
def insert_user(fullname, username, phonenumber, password):
    conn = sqlite3.connect(database)
    cursor = conn.cursor()
    try:
        cursor.execute(
            "INSERT INTO users (fullname, username, phonenumber, password) VALUES (?, ?, ?, ?)",
...
def sign_up():
    ...
    #sign-up box
    sign_up_frame = tk.Frame(window1, width=340, height=280, bg="#878378", relief="ridge", bd=2, padx=10)
    sign_up_frame.pack(fill="both", padx=20 )

    sign_up_label = tk.Label(sign_up_frame, text="Sign Up", font=("Times New Roman", 20), bg="#878378", fg="black")
    sign_up_label.pack()
    ...
    password_entry = tk.Entry(sign_up_frame, show="*", font=("Times New Roman", 12), bg="#878378", relief="solid")
    ...
    password_confirm_entry = tk.Entry(sign_up_frame, show="*", font=("Times New Roman", 12), bg="#878378", relief="solid")
    ...
    def register_user():
        ...
        if insert_user(fullname, username, phonenumber, password):
            messagebox.showinfo("Success", "Registration successful!")
            back_home()

    #register button
    reg_btn = tk.Button(sign_up_frame, text="Register", font=("Times New Roman", 12, "bold"), fg="black", bg="#878378", command=register_user)
...
def login():
    ...
    login_label = tk.Label(login_frame, text="Log In", font=("Times New Roman", 20), bg="#878378", fg="black")
    ...
    label_password.pack(fill="x")
    password_entry_login = tk.Entry(login_frame, show="*", font=("Times New Roman", 12), bg="#878378", relief="solid")
...
#to kill the signup page window when users click on the login button
def open_login2():
    window1.destroy()
    login()
